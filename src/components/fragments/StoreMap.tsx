...
export default function StoreMap() {
  return (
    <div className="w-[400px] h-[400px] xl:h-[450px] 2xl:h-[550px] sm:w-[550px] md:w-[670px] lg:w-[870px] xl:w-[1100px] 2xl:w-[1400px] shadow-lg overflow-hidden mx-auto lg:ml-24 lg:mx-0">
      <MapContainer
