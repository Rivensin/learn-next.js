...
export default function StoreMap() {
  return (
    <div className="w-full max-w-xs h-[400px] xl:h-[450px] 2xl:h-[550px] sm:max-w-2xl md:max-w-4xl lg:max-w-5xl xl:max-w-7xlshadow-lg overflow-hidden ml-4 lg:ml-24">
      <MapContainer
